...
class AccountInvoice(models.Model):
    ...
    misc_28 = fields.Char("Total")
    misc_30 = fields.Char("Número de factura")
    misc_34 = fields.Char("FACTURA DESALMACENAJE N")
    misc_35 = fields.Char("BODEGAJE DE ALMACÉN FISCAL")
    misc_36 = fields.Char("Estado")
    misc_37 = fields.Char("FACTURA AGENTE")
    misc_38 = fields.Char("PAGO CONSTANCIA LIMON")
    misc_39 = fields.Char("PERMISO PROCOMER")
    misc_40 = fields.Char("PROCOMER Y TIMBRES")
    misc_41 = fields.Char("Equilibrar")

    @api.onchange('misc_28','misc_30','misc_34','misc_35','misc_36','misc_37','misc_38','misc_39','misc_40','misc_41')
    def onchange_misc(self):
        txt = ''
        if self.misc_28:
            txt += 'TOTAL: ' + self.misc_28 +'\n'
        if self.misc_30:
            txt += "Número de factura: " + self.misc_30 +'\n'
        if self.misc_34:
            txt += "FACTURA DESALMACENAJE N: " + self.misc_34 +'\n'
        if self.misc_35:
            txt += "BODEGAJE DE ALMACÉN FISCAL: " + self.misc_35 +'\n'
        if self.misc_36:
            txt += "Estado: " + self.misc_36 +'\n'
        if self.misc_37:
            txt += "FACTURA AGENTE: " + self.misc_37 +'\n'
        if self.misc_38:
            txt += "PAGO CONSTANCIA LIMON: " + self.misc_38 +'\n'
        if self.misc_39:
            txt += "PERMISO PROCOMER: " + self.misc_39 +'\n'
        if self.misc_40:
            txt += "PROCOMER Y TIMBRES: " + self.misc_40 +'\n'
        if self.misc_41:
            txt += "Equilibrar: " + self.misc_41 +'\n'
        self.comment = txt
    ...
    def generate_file(self):
        ...
        if id.number and len(id.number) <= 20:
            ...
            id.misc_30 = str(id.company_id.store_branch+id.terminal.name+doc_type+id.number)
